            ...
            <div class="mem_content_group">
                ...
                <form class="mem_form" action="">
                    ...
                    <div class="tabcontent_txt_group">
                        ...
                        <ul class="tabcontent_txt">
                            <li><select  class="menu_choose" name="" id=""><option value="">桃園市</option></select></li>
                            <li><select class="menu_choose" name="" id=""><option value="">中壢市</option></select></li>
                    ...
                    <ul class="tabcontent_img">
                        <li>
                            <label for="sloth" class="select_img">
                                ...
                                <img src="@/assets/images/report/report_avatar_1.png" alt="">
                            </label>
                        </li>
                        <li>
                            <label for="bear" class="select_img">
                                <input type="radio" id="bear" name="namepic" class="input_none">
                                <img src="@/assets/images/report/report_avatar_2.png" alt="">
                            </label>
                        </li>
                        <li>
